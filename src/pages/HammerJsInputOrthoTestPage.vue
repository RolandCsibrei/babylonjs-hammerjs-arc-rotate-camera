...
import { HammerJsInputOrthoTestScene } from 'src/scenes/HammerJsInputOrthoTestScene'
...
export default defineComponent({
  ...
  setup(_, { root }) {
    ...
    let scene: HammerJsInputOrthoTestScene

    onMounted(async () => {
      if (bjsCanvas?.value) {
        scene = new HammerJsInputOrthoTestScene(bjsCanvas.value)
